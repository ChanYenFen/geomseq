...
KNN_K, USE_2OPT, MAX_PASSES = 12, True, 20  # 20 is what sort_curves ships
TOL = 1e-9
...
@pytest.mark.parametrize("name, segments", CASES.items(), ids=list(CASES.keys()))
def test_sort_curves(name, segments):
